{ pkgs, config, ... }: let cfg = config.modules.default-applications; in {
  options = with pkgs.lib; {
    modules.default-applications = {
      ...
      webBrowser = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default web browser.";
      };
      emailClient = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default email client.";
      };
      phoneHandler = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default phone handler.";
      };
      imageViewer = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default image viewer.";
      };
      musicPlayer = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default music player.";
      };
      videoPlayer = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default video player.";
      };
      textEditor = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default text editor.";
      };
      docViewer = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default document viewer.";
      };
      fileManager = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default file manager.";
      };
      terminal = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default terminal emulator.";
      };
      archiveManager = mkOption {
        type = types.str;
        default = null;
        description = "Absolute path in the nix store to the .desktop file for the default archive manager.";
      };
    };
  };
  config = let
    webBrowser = "${cfg.webBrowser}"; # "zen.desktop";
    emailClient = "${cfg.emailClient}"; # "proton-mail.desktop";
    phoneHandler = "${cfg.phoneHandler}"; # "org.kde.kdeconnect.handler.desktop";
    imageViewer = "${cfg.imageViewer}"; # "org.kde.gwenview.desktop";
    musicPlayer = "${cfg.musicPlayer}"; # "vlc.desktop";
